    ...
    <form wire:submit.prevent="create">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('bap.create_merchant') }}</h5>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-selectgroup">
                                <label class="form-selectgroup-item">
                                    <input type="checkbox" wire:model.defer="payment_type" name="payment_type" value="crypto" class="form-selectgroup-input" checked="">
