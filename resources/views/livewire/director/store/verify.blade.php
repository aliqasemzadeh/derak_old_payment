<div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('bap.verify_merchant') }}</h5>
                ...
                <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-selectgroup">
                                <label class="form-selectgroup-item">
                                    <input type="radio" wire:model.defer="payment_type.crypto" name="payment_type" value="true" class="form-selectgroup-input">
                                ...
                                <label class="form-selectgroup-item">
                                    <input type="radio" wire:model.defer="payment_type.fiat" name="payment_type" value="true" class="form-selectgroup-input">
                                    <span class="form-selectgroup-label">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea wire:model="note" class="form-control @error('note') is-invalid @enderror" name="description" placeholder="{{ __('bap.note') }}"></textarea>
                            @error('note')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="verify" class="btn btn-primary">{{ __('bap.verify') }}</button>
                <button type="button" wire:click="reject" class="btn btn-danger">{{ __('bap.reject') }}</button>
            </div>
        </div>
</div>
