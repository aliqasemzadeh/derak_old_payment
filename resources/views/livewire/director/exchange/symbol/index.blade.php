            ...
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                @foreach($symbols as $symbol)
                    <tr>
                        ...
                        <td class="text-end">
                            <button onclick="Livewire.emit('showModal', 'director.exchange.symbol.edit', '{{ json_encode($symbol->id) }}')" class="btn btn-primary btn-icon btn-sm">
                            ...
                            <a href="{{  route('director.exchange.symbol.transactions', [$symbol->id]) }}" class="btn btn-orange btn-icon btn-sm">
