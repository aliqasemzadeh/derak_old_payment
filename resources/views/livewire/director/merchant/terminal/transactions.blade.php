<div>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('director.merchant.terminal.index', [$terminal->merchant->id]) }}">{{ $terminal->merchant->title }} - {{ __('bap.terminals') }} - {{ __('bap.transactions') }}</a></li>
        </ol>
    </x-slot>
