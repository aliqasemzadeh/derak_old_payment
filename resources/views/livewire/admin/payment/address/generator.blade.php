<div>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.payment.address.generator') }}">{{ __('bap.address_generator') }}</a></li>
        </ol>
    </x-slot>
                ...
                <div class="col-12">
                    <form wire:submit.prevent="export" method="post" class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('bap.address_generator') }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
