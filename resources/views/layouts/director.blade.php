                ...
                <ul class="navbar-nav pt-lg-3">
                    ...
                    @endcan
                        ...
                        @can('director_user_index')
                            <li class="nav-item dropdown @if(\Illuminate\Support\Facades\Route::is('director.user.*')) show @endif">
                                ...
                                @can('director_user_index')
                                    <div
                                        class="dropdown-menu @if(\Illuminate\Support\Facades\Route::is('director.user.*')) show @endif"
                                        data-bs-popper="none">

                                        <a class="dropdown-item @if(\Illuminate\Support\Facades\Route::is('director.user.index')) active @endif"
                                           href="{{ route('director.user.index') }}">
                                            {{ __('bap.users') }}
                                        </a>
                                        <a class="dropdown-item @if(\Illuminate\Support\Facades\Route::is('director.user.verify.index')) active @endif"
                                           href="{{ route('director.user.verify.index') }}">
                                            {{ __('bap.users_verify') }}
                                        </a>
                    ...
                    @can('director_store_index')
                    <li class="nav-item @if(\Illuminate\Support\Facades\Route::is('director.store.index')) active @endif">
                        <a class="nav-link" href="{{ route('director.store.index') }}">
                    ...
                    <li class="nav-item @if(\Illuminate\Support\Facades\Route::is('director.bounce.index')) active @endif">
                        <a class="nav-link" href="{{ route('director.bounce.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-bounce"
                                 width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                 fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
