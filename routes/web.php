...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['referral']], function() {
    ...
    Route::group(['middleware' => ['auth:sanctum', 'verified']], function() {
        ...
        Route::group(['prefix' => config('bap.admin-prefix-url'), 'middleware' => ['auth:sanctum', 'verified', 'admin']], function () {
            ...
            Route::get('/payment/x-pub/index', \App\Http\Livewire\Admin\Payment\XPub\Index::class)->name('admin.payment.x-pub.index');
        });
        ...
        Route::group(['prefix' => config('bap.store-prefix-url'), 'middleware' => ['auth:sanctum', 'verified', 'store']], function () {
            ...
            Route::get('/invoice/index', \App\Http\Livewire\Store\Invoice\Index::class)->name('store.invoice.index');
            ...
            Route::get('/staff/index', \App\Http\Livewire\Store\Staff\Index::class)->name('store.staff.index');
